...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [🌼]() `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *ㄹ ㅇ𝙰𝚖𝚒ㅇ ㄹ*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝔸𝕕𝕕 𝕄𝕖 𝕐𝕠𝕦𝕣 𝔾𝕣𝕠𝕦𝕡", url="t.me/Amiqeensl_bot?startgroup=true"),
    ],
     [
     ...
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭", url="https://t.me/TME_BOT_SUPPORT_CHAT"),
        InlineKeyboardButton(text="𝐑𝐞𝐩𝐨🇱🇰", url="https://github.com/Captainamarica/Group-maneger-Bot1"),
    ], 

    [
        InlineKeyboardButton(text="𝐇𝐞𝐥𝐩 & 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬 ㄹ ㅇ𝙰𝚖𝚒ㅇ ㄹ", callback_data="help_back"),
    ],
]
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖`  *ㄹ ㅇ𝙰𝚖𝚒ㅇ ㄹ* [🌼](https://telegra.ph/file/86b95880cb911d1f2eef0.jpg)
`𝙲𝚕𝚒𝚌𝚔 𝚘𝚗 𝚝𝚑𝚎 𝚋𝚞𝚝𝚝𝚘𝚗𝚜 𝚋𝚎𝚕𝚘𝚠 𝚝𝚘 𝚐𝚎𝚝 𝚍𝚘𝚌𝚞𝚖𝚎𝚗𝚝𝚊𝚝𝚒𝚘𝚗 𝚊𝚋𝚘𝚞𝚝 𝚜𝚙𝚎𝚌𝚒𝚏𝚒𝚌 𝚖𝚘𝚍𝚞𝚕𝚎𝚜..`"""
evil_IMG = "https://telegra.ph/file/86b95880cb911d1f2eef0.jpg"
